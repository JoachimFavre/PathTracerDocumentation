...
This is the code for the documentation of a Path Tracer I wrote throughout 2020 in the context of my Travail de Maturité (see [my repositoriy](https://github.com/JoachimFavre/PathTracer)). The documentation can found at the following url: https://joachimfavre.github.io/PathTracerDocumentation/.
